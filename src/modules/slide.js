...
export class Slide {
  ...
  /*  recebe a quantidade movida,
  e subtrai de onde foi o clique inicial( *1.6 para  o slide correr mais).
  ...
  */
  ...
  /*  chama a updatePosition que faz o calculo
   para a posição final (do click inicial - a quantidade movida).
